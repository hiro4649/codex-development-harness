...
function contractTests() {
  ...
  return [
    ...
    test('v130_active_state_pass', () => policy.candidateHarnessVersion === '1.3.0' && policy.candidateActivationState === 'active' && policy.sourceActivation === 'active'),
    ...
    test('v130_source_manifest_active_registered', () => source.activeHarnessVersion === '1.3.0' && source.activeSelfTestSuite === 'v130' && source.v130SourceShadowCandidate?.candidateActivationState === 'active'),
    ...
    test('v130_active_policy_registered', () => activePolicy.marker === 'CODEX_QUALITY_HARNESS_FILE v1.3.0'),
    test('v130_readme_state_current', () => readme.includes('Active Source: v1.3.0') && readme.includes('Candidate: v1.3.0 active')),
    test('v130_agents_marker_preserves_active_v130', () => agents.includes('CODEX_QUALITY_HARNESS_FILE v1.3.0') && agents.includes('Candidate Source: v1.3.0 active')),
