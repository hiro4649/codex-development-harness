...
const compatibilityCases = [
  ...
  ['v124_active_authority_tuple_is_current_or_successor', () => ['v124', 'v125'].includes(buildOrchestrationCapsule().skillContextRouting.activeAuthorityTuple.activeSelfTestSuite)],
];
