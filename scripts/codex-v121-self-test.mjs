...
const calibrationCases = [
  ...
  ['routing_calibration_allows_justified_highest_tier', () => validateRoutingCalibration({ ...buildOrchestrationCapsule().routingCalibration, currentTier: 'highest_reasoning_reviewer', escalationWasRequired: true, escalationReason: 'security_sensitive_ambiguity' }).status === 'pass'],
