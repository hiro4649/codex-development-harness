...
const cases = [
  ...
  test('evidence_capsule_is_machine_authority', () => validateEvidenceCapsule(buildEvidenceCapsule({ terminalAction: 'merge_current_pr', headSha: 'abc', qualityGateRunId: 'run', artifactId: 'artifact', prHeadSha: 'abc', workflowHeadSha: 'abc', artifactHeadSha: 'abc' })).status === 'pass'),
  ...
  test('freshness_requires_head_qg_artifact_tuple', () => buildEvidenceCapsule({ terminalAction: 'merge_current_pr', headSha: 'abc', qualityGateRunId: 'run', artifactId: 'artifact', prHeadSha: 'abc', workflowHeadSha: 'abc', artifactHeadSha: 'abc' }).fresh === true),
