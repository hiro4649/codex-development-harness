...
export const previousSelfTestStatusKey = 'v129SelfTestStatus';
export const compatibilitySelfTestStatusKeys = ['v127SelfTestStatus', 'v128SelfTestStatus'];
export const activeHarnessVersion = '1.3.0';
export const activeSelfTestStatusKey = 'v130SelfTestStatus';
export const activeSelfTestSuite = 'v130';
export const candidateHarnessVersion = '1.3.0';
export const candidateSelfTestStatusKey = 'v130SelfTestStatus';
export const candidateSelfTestSuite = 'v130';
...
export const versionLineagePolicy = {
  ...
  shadowTargetCanary: 'not_applicable_source_only',
