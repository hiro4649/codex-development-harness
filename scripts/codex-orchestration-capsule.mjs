...
import {
  ...
  currentVersion,
} from './codex-harness-version.mjs';
...
function defaultActiveAuthorityTuple(input = {}) {
  return {
    agentsMarker: input.agentsMarker || `CODEX_QUALITY_HARNESS_FILE v${currentVersion}`,
    manifestActiveHarnessVersion: input.manifestActiveHarnessVersion || activeHarnessVersion,
    activeSelfTestSuite: input.activeSelfTestSuite || activeSelfTestSuite,
    activeSpecPath: input.activeSpecPath || `docs/process/CODEX_${activeSelfTestSuite.toUpperCase()}_SPEC.md`,
    candidateHarnessVersion: input.candidateHarnessVersion || candidateHarnessVersion,
    candidateSelfTestSuite: input.candidateSelfTestSuite || candidateSelfTestSuite,
    candidateSpecPath: input.candidateSpecPath || `docs/process/CODEX_${candidateSelfTestSuite.toUpperCase()}_SPEC.md`,
    candidateActivationState: input.candidateActivationState || candidateActivationState,
...
function defaultSkillContextRouting(input = {}) {
  ...
  return {
    ...
    requiredFirstReads: truncateList(input.requiredFirstReads || ['AGENTS.md', 'docs/process/CODEX_HARNESS_MANIFEST.json', `docs/process/CODEX_${activeSelfTestSuite.toUpperCase()}_SPEC.md`], 8),
...
function defaultWorkspaceIdentityGate(input = {}) {
  ...
  return {
    workspaceIdentityVersion: activeHarnessVersion,
...
export function buildOrchestrationCapsule(input = {}) {
  ...
  return {
    ...
    sourceHarnessVersion: input.sourceHarnessVersion || activeHarnessVersion,
    activeHarnessVersion: input.activeHarnessVersion || activeHarnessVersion,
    candidateHarnessVersion: input.candidateHarnessVersion || candidateHarnessVersion,
    candidateActivationState: input.candidateActivationState || candidateActivationState,
...
export function validateWorkspaceIdentityGate(gate = {}) {
  const reasons = [];
  if (!['1.2.3', '1.2.4', '1.2.5', '1.2.6', '1.2.7', '1.2.8', '1.2.9', '1.3.0'].includes(gate.workspaceIdentityVersion)) reasons.push('workspace_identity_version_invalid');
  ...
  if (!['1.2.3', '1.2.4', '1.2.5', '1.2.6', '1.2.7', '1.2.8', '1.2.9', '1.3.0'].includes(gate.manifestActiveHarnessVersion)) reasons.push('workspace_identity_manifest_version_invalid');
...
export function validateActivePolicyIndex(index = {}) {
  const reasons = [];
  if (!['1.2.3', '1.2.4', '1.2.5', '1.2.6', '1.2.7', '1.2.8', '1.2.9', '1.3.0'].includes(index.schemaVersion)) reasons.push('active_policy_index_schema_invalid');
...
export function validateSkillContextRouting(routing = {}) {
  ...
  if (!['1.2.2', '1.2.3', '1.2.4', '1.2.5', '1.2.6', '1.2.7', '1.2.8', '1.2.9', '1.3.0'].includes(routing.schemaVersion)) reasons.push('skill_context_routing_schema_invalid');
  ...
  if (!['CODEX_QUALITY_HARNESS_FILE v1.2.2', 'CODEX_QUALITY_HARNESS_FILE v1.2.3', 'CODEX_QUALITY_HARNESS_FILE v1.2.4', 'CODEX_QUALITY_HARNESS_FILE v1.2.5', 'CODEX_QUALITY_HARNESS_FILE v1.2.6', 'CODEX_QUALITY_HARNESS_FILE v1.2.7', 'CODEX_QUALITY_HARNESS_FILE v1.2.8', 'CODEX_QUALITY_HARNESS_FILE v1.2.9', 'CODEX_QUALITY_HARNESS_FILE v1.3.0'].includes(authority.agentsMarker)) reasons.push('active_authority_agents_marker_missing');
  if (!['1.2.2', '1.2.3', '1.2.4', '1.2.5', '1.2.6', '1.2.7', '1.2.8', '1.2.9', '1.3.0'].includes(authority.manifestActiveHarnessVersion)) reasons.push('active_authority_manifest_version_missing');
  ...
  if (!['compiled_instruction_envelope', 'docs/process/CODEX_V122_SPEC.md', 'docs/process/CODEX_V123_SPEC.md', 'docs/process/CODEX_V124_SPEC.md', 'docs/process/CODEX_V125_SPEC.md', 'docs/process/CODEX_V126_SPEC.md', 'docs/process/CODEX_V127_SPEC.md', 'docs/process/CODEX_V128_SPEC.md', 'docs/process/CODEX_V129_SPEC.md', 'docs/process/CODEX_V130_SPEC.md'].includes(authority.activeSpecPath)) reasons.push('active_authority_spec_path_missing');
