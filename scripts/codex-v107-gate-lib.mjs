...
export function buildCentralHarnessVersionRegistryReport(input = {}) {
  ...
  const reasons = [];
  const compatibleCurrent = registry.currentVersion === '1.0.7' || registry.currentVersion === '1.0.8' || registry.currentVersion === '1.0.9' || registry.currentVersion === '1.1.0' || registry.currentVersion === '1.1.1';
  const compatiblePrevious = registry.previousVersion === '1.0.6' || registry.previousVersion === '1.0.7' || registry.previousVersion === '1.0.8' || registry.previousVersion === '1.0.9' || registry.previousVersion === '1.1.0';
  const compatibleSelfTest = registry.activeSelfTestStatusKey === 'v107SelfTestStatus' || registry.activeSelfTestStatusKey === 'v108SelfTestStatus' || registry.activeSelfTestStatusKey === 'v109SelfTestStatus' || registry.activeSelfTestStatusKey === 'v110SelfTestStatus' || registry.activeSelfTestStatusKey === 'v111SelfTestStatus';
