...
const compatibilityCases = [
  ...
  ['v125_active_authority_tuple_preserves_current_or_v125', () => ['v125', 'v126', 'v127', 'v128'].includes(buildOrchestrationCapsule().skillContextRouting.activeAuthorityTuple.activeSelfTestSuite)],
];
