...
const routingCases = [
  ['skill_context_routing_exists_inside_orchestration_capsule', () => ['1.2.2', '1.2.3', '1.2.4', '1.2.5', '1.2.6', '1.2.7', '1.2.8', '1.2.9', '1.3.0'].includes(buildOrchestrationCapsule().skillContextRouting.schemaVersion)],
  ...
  ['read_less_preserve_authority_first_reads', () => {
    ...
    return firstReads.includes('AGENTS.md') && firstReads.includes('docs/process/CODEX_HARNESS_MANIFEST.json') && (firstReads.includes('docs/process/CODEX_V122_SPEC.md') || firstReads.includes('docs/process/CODEX_V123_SPEC.md') || firstReads.includes('docs/process/CODEX_V124_SPEC.md') || firstReads.includes('docs/process/CODEX_V125_SPEC.md') || firstReads.includes('docs/process/CODEX_V126_SPEC.md') || firstReads.includes('docs/process/CODEX_V127_SPEC.md') || firstReads.includes('docs/process/CODEX_V128_SPEC.md') || firstReads.includes('docs/process/CODEX_V129_SPEC.md') || firstReads.includes('docs/process/CODEX_V130_SPEC.md'));
  }],
