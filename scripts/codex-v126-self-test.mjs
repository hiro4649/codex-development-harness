...
const compatibilityCases = [
  ...
  ['v126_compatibility_survives_current_active_authority', () => ['v126', 'v127', 'v128', 'v129'].includes(buildOrchestrationCapsule().skillContextRouting.activeAuthorityTuple.activeSelfTestSuite)],
];
