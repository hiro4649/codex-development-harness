...
const compatibilityCases = [
  ...
  ['v126_compatibility_survives_current_active_authority', () => ['v126', 'v127', 'v128', 'v129', 'v130'].includes(buildOrchestrationCapsule().skillContextRouting.activeAuthorityTuple.activeSelfTestSuite)],
];
