...
const compatibilityCases = [
  ...
  ['v126_compatibility_survives_v127_v128_active_authority', () => ['v126', 'v127', 'v128'].includes(buildOrchestrationCapsule().skillContextRouting.activeAuthorityTuple.activeSelfTestSuite)],
];
