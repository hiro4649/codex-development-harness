...
The workflow must create a minimal safe failure artifact before the quality gate
runs. The artifact records only phase, last known gate, safe reason codes, and a
short next action.
