...
Long runs stop or checkpoint at 120 minutes, 300 tool calls, 100 file writes, one retry per node, and one parallel runtime. A compact heartbeat is limited to 512 bytes every three completed nodes.
