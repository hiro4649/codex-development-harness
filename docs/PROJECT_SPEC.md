...
- Target Profile Installer Dry Run rejects `CODEX_SOURCE_HARNESS_MANIFEST.json` when it appears in target install diffs, even if the caller forgot to set the explicit source-manifest-copied flag.
